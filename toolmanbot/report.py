...
#Unicorn
    if max(values1)==values1[0]:
        ...
        text = point
        cv2.putText(imageA, text, (17, 195), cv2.FONT_HERSHEY_SCRIPT_SIMPLEX,2,(0, 0, 0), 4, cv2.LINE_AA)
        text1 = difference
        cv2.putText(imageA, text1, (145, 200), cv2.FONT_HERSHEY_COMPLEX,0.55,(22, 116, 226), 1, cv2.LINE_AA)
...
#PloarBear
        ...
        text = point
        cv2.putText(imageA, text, (15, 150), cv2.FONT_HERSHEY_SCRIPT_SIMPLEX,1.75,(0, 0, 0), 4, cv2.LINE_AA)
        text1 = difference
...
#Peacock
        ...
        text = point
        cv2.putText(imageA, text, (55, 155), cv2.FONT_HERSHEY_SCRIPT_SIMPLEX,1.75,(0, 0, 0), 4, cv2.LINE_AA)
        text1 = difference
