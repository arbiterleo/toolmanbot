...
def draw(CLIENT_ID,values,values_a,point,difference):
  ...
  if max1-max2 >10:
    ...
    ax.plot(angles, values_a, 'o-', linewidth=2,color="#579598", label = "User")
    ax.fill(angles, values_a,color="#00FFD4", alpha=1)

    ax.plot(angles, values, 'o-', linewidth=2,color="#7E7E7E", label = 'Avg')
    ax.fill(angles, values,color="#F5F5F5", alpha=0.75)
